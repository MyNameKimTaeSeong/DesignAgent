...
<div id="wrapper">
		...
		<div id="content" class="boxSize">
			...
			<form action="../Draft/FileUpload.do?sort=m" method="post" enctype="multipart/form-data">
				...
				<div id="btn" class="boxSize">
					...
					<a href="draft_mass.jsp"><input type="button" id="cancel" class="btn" value="Cancel"></a>
				</div>
			</form>
		</div>
